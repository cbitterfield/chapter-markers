...
PACKAGE_NAME = 'chapter-markers'
DESCRIPTION = 'chapter-markers contains all the '\
...
setup(
    ...
    test_suite='tests',
    url='git@github.com:cbitterfield/chapter-markers.git',
    zip_safe=False,
    classifiers=[
    ...
    entry_points={
        'console_scripts': [
            'chapter-markers=chapter-markers.chapter-markers:main',
        ],
    },
    license="MIT license",
)
