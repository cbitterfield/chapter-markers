...
chapter-markers contains all the boilerplate you need to create a Python package.

Get Started!
--------
Here’s how to set up *chapter-markers* for local environment.

1- Clone the *chapter-markers* locally:
